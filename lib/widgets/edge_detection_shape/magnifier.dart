...
class _MagnifierState extends State<Magnifier> {
  ...
  void _calculateMatrix() {
    ...
    setState(() {
      double newX = widget.position!.dx - (_magnifierSize.width / 2.2 / _scale);
      double newY =
          widget.position!.dy - (_magnifierSize.height / 6.2 / _scale);
    ...
    return Align(
      ...
      child: ClipOval(
        child: BackdropFilter(
          ...
          child: CustomPaint(
            painter: const MagnifierPainter(color: Colors.white),
            size: _magnifierSize,
          ),
        ),
      ),
